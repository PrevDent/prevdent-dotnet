...
{
    private readonly ISentimentAnalysisApplicationService _sentimentService;

    public SentimentController(ISentimentAnalysisApplicationService sentimentService)
    {
